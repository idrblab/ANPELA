...
Installed from ***CRAN*** (can also from other repositories): dplyr, doParallel, rstan, Rtsne, pastecs, cowplot, ggpubr, gridExtra, MLmetrics, fossil, clusterCrit, VennDiagram, stringr, bbmle, mc2d, parallel, doSNOW, foreach, igraph, mclust, pheatmap, magrittr, withr and tree.
...
Installed from ***Bioconductor*** (can also from other repositories): flowCore, limma, SCORPIUS, slingshot, destiny, flowStats, flowAI, flowCut, flowClean, spillR, PeacoQC, systemPipeR and flowTrans.
...
Installed from ***GitHub*** (can also from other repositories): Rtsne.multicore, Rphenograph and CytoSpill.
