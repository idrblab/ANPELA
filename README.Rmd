...
Installed from ***Bioconductor*** (can also from other repositories): flowCore, limma, SCORPIUS, slingshot, destiny, flowStats, flowAI, flowCut, flowClean, spillR, PeacoQC and systemPipeR.
...
Installed from ***GitHub*** (can also from other repositories): Rtsne.multicore and Rphenograph.
