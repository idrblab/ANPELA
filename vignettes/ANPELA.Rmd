...
Reading the FCS files, the metadata file and the pathway hierarchy file is a crucial step before data processing. Let's take Example data acquired from mass cytometry for PTI analysis from a research about signal transduction as an example. Download MC_PTI sample data and position the files to the working directory.
